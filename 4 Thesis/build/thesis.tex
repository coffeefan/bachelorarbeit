...
immer mehr ihren Content mit so genannten Playfull Content oder Deutsch
Interaktivitäten. Dabei handelt sich um Abstimmungen, Wettbewerbe und
...
376 Stunden veranschlagt. Der effektive aufgelaufene Aufwand betrug xx
Stunden.
...
Wisschenschaftlichen Formaten erzeugt werden. Im Intranet der ZHAW wird
...
visualisieren bedarf es ein Tool dass die Diagramm sowohl optisch
ansprechend wie aber auch einfach und schnell anpassbar umsetzt. yUML
ist ein gratis Online-Service über welchen mittels Code ein UML-Diagramm
kreiert werden kann. Diese Art von UML designen ist daher sehr
strukturiert und nachvollziehbar. Der Code welche zum Diagramm führt
...
der Schweiz die Plattform. Tamedia erfasst neu immer wieder auf
...
Grenzen. Individuelle Erweiterungen sind nicht einfach möglich.
...
Der Erwerb so einer SuisseID kostet den Endkunden eine beträchtliche
Summe Geld. Der Anbieter der Authentifizierung erwarten keine grossen
Kosten. Dadurch ist eine kleine Verbreitung für privaten Nutzen
offensichtlich. Entwickler von Integrationen erhalten eine ganzes SDK
und Kontaktmöglichkeiten

\subsubsection{Vorteile}\label{vorteile-3}

Hohe Sicherheit durch sichere und eindeutige Authentifikation.
Rechtliche Vorraussetzungen sind gegeben. Enwickler von Integrationen
werden unterstützt.
...
schützen können oder gar ganze Packages anbieten. Ein Service welcher es
erlaubt individuell konfigurierbare Sicherheitstufen festzulegen und
...
verbreitet. Die Möglichkeiten von verschiedenen Authentifizierung ist
...
\subsubsection{Automatisierungsmöglichkeit und Mehrfach
...
Die Automatisierte Teilnahme und Löschung ist im Gegensatz zu klassichen
...
Die Zwei-Faktor-Authentifizierung OAuth ist im Kapitel
...
welche dem Developer eine Breite Auswahlmölgichkeit bietet
\protect\hyperlink{ux5cux23ux5cux23NFREQ-210}{NFREQ-210} und eine
genügende Verbreitung in der Schweiz hat ({[}NFREQ-212{]}), ihn aber
...
der Schweiz ({[}NFREQ-212{]}) keine genügende Note und wird daher
ausgeschlossen. Um die geforderte Breite an Sicherheitsmethoden zu
