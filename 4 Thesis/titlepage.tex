...
% Logo
\ThisTileWallPaper{\paperwidth}{\paperheight}{images/logos/IDP.pdf} % {images/logos/*.pdf}
...
\begin{tiny}.\end{tiny}\vskip 2.8cm
	...
	% Projekt Name
	\textbf{\underline{Projektarbeit (Wirtschaftsingenieurwesen)}}\\
	%\textbf{\underline{ }}
	
	% Projekt Titel
	Prädikative Abschätzung von Eigenleistungen aufgrund von Projektmerkmalen
	\vskip 3.5cm}
