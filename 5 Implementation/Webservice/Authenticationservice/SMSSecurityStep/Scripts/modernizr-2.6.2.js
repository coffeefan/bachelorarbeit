        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    } else if ( /^(url|SMS)$/.test(inputElemType) ) {
                      // Real url and SMS support comes with prebaked validation.
            ...
            return inputs;
        })('search tel url SMS datetime date month week time datetime-local number range color'.split(' '));
        /*>>inputtypes*/
    }
    /*>>webforms*/
