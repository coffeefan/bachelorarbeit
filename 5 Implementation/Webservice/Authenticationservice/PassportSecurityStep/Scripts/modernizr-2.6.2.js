...
window.Modernizr = (function( window, document, undefined ) {
     ...
     *    the Palm Pre / WebOS (touch) Passports.
     *
        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    } else if ( /^(url|Passport)$/.test(inputElemType) ) {
                      // Real url and Passport support comes with prebaked validation.
            ...
            return inputs;
        })('search tel url Passport datetime date month week time datetime-local number range color'.split(' '));
        /*>>inputtypes*/
    }
    /*>>webforms*/
