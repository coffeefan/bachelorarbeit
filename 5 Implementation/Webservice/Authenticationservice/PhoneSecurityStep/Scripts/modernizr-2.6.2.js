        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    } else if ( /^(url|Phone)$/.test(inputElemType) ) {
                      // Real url and Phone support comes with prebaked validation.
            ...
            return inputs;
        })('search tel url Phone datetime date month week time datetime-local number range color'.split(' '));
        /*>>inputtypes*/
    }
    /*>>webforms*/
