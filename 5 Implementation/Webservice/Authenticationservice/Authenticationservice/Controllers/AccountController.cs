...
namespace Authenticationservice.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetUserInfo()
        {
            ...
            else
            {
                if (user.EmailConfirmed == false)
                {
                    ...
                    Result feedback = SendConfirmMail(new RegisterBindingModel().UserToBindingModel(user),user, code);
                    return BadRequest("Sie haben Ihre E-Mail noch nicht bestätigt. Eine entsprechende E-Mail wurde Ihnen soeben nochmals zugesendet.");
                }
        ...
        */
        ...
        private static Result SendConfirmMail(RegisterBindingModel model, ApplicationUser user, string code)
        {
