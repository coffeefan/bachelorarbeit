namespace Authenticationservice.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            CreateTable(
                "dbo.ProjectAuthentications",
                c => new
                    {
                        ProjectAuthenticationId = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.ProjectAuthenticationId)
                ...
                c => new
                    {
                        ...
                        ProjectId = c.Int(nullable: false),
                        SecurityStep = c.Int(nullable: false),
                        AdditionalConfiguration = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProjectAuthentications", "ProjectId", "dbo.Projects");
            ...
            DropIndex("dbo.ProjectAuthentications", new[] { "ProjectId" });
            ...
            DropTable("dbo.ProjectAuthentications");
        }
    }
}
